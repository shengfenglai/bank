...
<script type="text/javascript" src="js/checkGet.js" ></script>
</head>
...
<body>
	...
	<div class="nav">
		<ul>
			...
			<li><a href="balance.do?command=balance">查询余额</a>
			</li>
	...
	<div class="content">
		...
		<div class="main2">
			<div id="m">
				<form action="getMoney.do?command=getMoney" method="post" id="getMoneyForm">
					<table>
						<tr height="30">
						...
						<tr>
							...
							<input type="image" src="images/sure.png" onclick="checkGet();return false"/>
							</td>
						</tr>
					</table>
				</form>
