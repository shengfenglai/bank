...
<script type="text/javascript" src="js/checkSave.js" ></script>
</head>
...
<body>
	...
	<div class="content">
		...
		<div class="main2">
			<div id="m">
				<form action="saveMoney.do?command=saveMoney" method = "post" id="saveForm">
					<table>
						<tr height="30">
							<td align="right" width="70">存款金额：</td>
							<td align="left" width="150">
								<input type="text" name="money" id="money" onblur="checkSave()"/>
								<span class="word_orange" id="ss"></span>
							</td>
						</tr>
						<tr>
							<td colspan="2" align="center" height="70">
							<input type="image" src="images/sure.png" onclick="check();return false"/>
							</td>
						</tr>
					</table>
				</form>
