...
<body>
	...
	<div class="content">
		...
		<div class="main2">
			<div id="m">
				<form action="register.do" method = "get" id="regForm">
					<table>
						<tr height="30">
							<td align="right" width="70" title="用户名必须在6-12位之间">账&nbsp;&nbsp;号：</td>
						...
						<tr height="30">
							<td align="right" width="70" title="密码必须是一个六位数的数字">密&nbsp;&nbsp;码：</td>
							<td align="left" width="150">
						...
						<tr height="30">
							<td align="right" width="70" title="金额必须大于或等于10元">金&nbsp;&nbsp;额：</td>
							<td align="left" width="150">
